      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-md-8 col-sm-12">
            ...
            <ProgressBar now={progress.french} className="my-bar" label="C2" />

            <h4>Anglais : <span>Intermédiaire</span></h4>
            <ProgressBar now={progress.english} className="my-bar" label="B1" />

            <h4>Espagnol : <span>Débutant</span></h4>
            <ProgressBar now={progress.spanish} className="my-bar-spanish" label="A1" />
          </div>
        </div>
      </div>
    </div>
